export const projects = [
  {
    ...
    visit: 'https://github.com/peach003/Car-rental',
    id: 0,
  },
  {
    ...
    visit: 'https://github.com/peach003/Highway-Intelligent-Image-Recognition-Toll-Collection-System',
    id: 1,
  },
  {
    title: 'AI-powered English learning platform',
    description: "Built an AI English learning platform using React, D3.js, .NET C#, SQL Server, Deepgram API, Oxford Dictionary API and Transformer-based recommendation system, delivering adaptive learning paths, accurate speech-to-text, and interactive visualizations that improved user engagement and retention.",
      image: '/images/3.png',
      tags: ['.NET','React', 'SQL Server','Deepgram API','Transformer','Oxford Dictionary API'],
    source: 'https://github.com/peach003/EnglishLearningAPI',
    visit: 'https://github.com/peach003/EnglishLearningAlgorithms',
    id: 2,
  },
  {
...
export const TimeLineData = [
  { year: 'Before 2024', text: 'AS a banker of numbers', },
  { year: 2024.04, text: 'Started my IT journey', },
  { year: '2024.04-2025.04', text: 'Upgraded to version M.S. in Software Engineering.', },
  { year: 'Now', text: 'Jack into the IT matrix — loading skills, deploying ambition.', },
